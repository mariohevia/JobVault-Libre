# JobVault Libre
A privacy-centred, open-source job application tracker designed for users who want full control over their data. JobVault Libre runs entirely on your own machine and stores all information locally, providing a secure and dependable alternative to cloud-based job-tracker tools.
...
- Deliver a local-only job tracker that preserves user privacy
- Provide a straightforward, native desktop interface
- Maintain an open-source codebase that users can audit and extend
- Avoid cloud storage, online accounts, and telemetry
- Support future integration with optional browser extensions for collecting job information directly from websites
